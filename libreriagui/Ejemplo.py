# BIENVENIDO A MI EJEMPLO, SOY HUGO, Y HE CREADO UNA LIBRERÍA PARA FACILITAR EL DESARROLLO DE PROGRAMA CON INTERFAZ GRÁFICA EN PYTHON PARA MIS PROFESORES DE INFORMÁTICA(VÍCTOR, CARLOS)
